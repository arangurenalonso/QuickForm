...
interface IntegerFieldRulesFormValues {
  required: boolean;
...
const DEFAULTS: IntegerFieldRulesFormValues = {
  required: false,
...
const IntegerFieldRulesForm: React.FC<IntegerFieldRulesFormProps> = ({
  ...
  useEffect(() => {
    if (formFieldConfig?.type !== FieldTypeEnum.InputTypeInteger) return;
  ...
  const onSubmit = useCallback(
    (data: IntegerFieldRulesFormValues) => {
      const min = data.min;
      const max = data.max;
...
export default IntegerFieldRulesForm;
